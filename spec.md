...
- verify focused Task Console mouse wheel scrollback, Task Live Preview mouse wheel scrollback, Task Live Preview drag-copy selection, and focused-console drag-copy selection
